...
db.addUser('kapauUser', '12345');
db.auth('kapauUser','12345');
|
db.createUser(
    {
      user: "kapauUser",
...
$config['mongo_db']['default']['username'] = 'kapauUser';
$config['mongo_db']['default']['password'] = '12345';
$config['mongo_db']['default']['database'] = 'kapau';
